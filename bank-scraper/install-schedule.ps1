...
<#
================================================================================
  install-schedule.ps1 — רושם ב-Windows משימה שמריצה את "scheduler.ps1" כל 30 דקות.
  ...
  "כל 30 דקות" אינו "כל 30 דקות לבנק". ההתעוררות היא קריאה של קובץ קטן על
  המחשב, בלי רשת ובלי בנק, שמסתיימת תוך שבריר שנייה. הכניסה לבנק עצמה מוגבלת
  לפעם אחת ביום - ההסבר המלא בראש scheduler.ps1.
...
Write-Host "היא מתעוררת כל $EveryMinutes דקות ובודקת בקובץ מקומי אם הגיע הזמן."
Write-Host "הכניסה לבנק עצמה היא פעם אחת ביום בלבד." -ForegroundColor Yellow
