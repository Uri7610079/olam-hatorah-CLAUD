  ...
  return (
    <div>
      ...
      <div className="mb-4 flex items-start gap-2 rounded-md border border-slate-200 bg-slate-50 p-3 text-sm text-slate-600">
        <span>
          השפעת הרטרו על יתרת הקבוצה תחובר לספר התנועות בשלב 8. כאן נשמרים רק הנתונים והחישוב - אין עדכון יתרה עדיין.
          אין נוסחת ניקוד קבועה: אם התקבל ניקוד במקור, יש להזין אותו כהערה בלבד.
        </span>
      </div>
